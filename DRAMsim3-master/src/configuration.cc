...
void Config::SetAddressMapping() {
   ...
   // std::cout<<"ch_mask"<<std::hex << ch_mask<<std::endl;
   // std::cout<<"ra_mask"<<std::hex << ra_mask<<std::endl;
   // std::cout<<"bg_mask"<<std::hex << bg_mask<<std::endl;
   // std::cout<<"ba_mask"<<std::hex << ba_mask<<std::endl;
   // std::cout<<"ro_mask"<<std::hex << ro_mask<<std::endl;
   // std::cout<<"co_mask"<<std::hex << co_mask<<std::endl;
}
